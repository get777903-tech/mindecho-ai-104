...
const appState = {
  ...
  azureProfileId: null,
  isCalibRecording: false,
  calibMediaRecorder: null,
  calibChunks: [],
  elevenlabsVoiceId: null,
  elevenlabsAudioUrl: null,
  isCalibRevealed: false
};
...
// Russian Meditation Template Text (User's canonical version)
const BASE_MEDITATION_TEMPLATE_RU = `{NAME}, я хочу взять тебя с собой в небольшое путешествие в волшебное место, где мысли становятся реальностью, и чтобы мы смогли туда попасть, нам нужно будет раскрыть свою душу. Так что слушай меня внимательно и давай отправимся в это весёлое путешествие.
...
Потому что это тот мир, который ты построила сама и в котором всё, во что ты веришь — это правда. Это тот самый мир, где всё действительно сбывается, где мысли становятся реальными и где всё, во что ты веришь, может случиться. Думай о том, что в этом месте ты — настоящая волшебница и всё подвластно твоей воле.

Поверь в то, что ты умна, и что ты очень быстро и легко учишься. Поверь в это, и всё сбудется. Почувствуй уверенность в своих силах, думай о том, как легко тебе даются любые новые знания.

Поверь в то, что тебя очень сильно любят, и почувствуй это всем своим сердцем, и пусть душа наполнится счастьем. Представь тёплое сияние в груди, вдыхай это чувство любви каждой клеточкой. Знай, что мама и папа тебя очень любят, мама и папа рады, что ты у них есть.
...
Поверь в своих друзей и родственников и будь сама верной подругой. Обращайся с людьми так, как ты хочешь, чтобы обращались с тобой, и они станут твоими друзьями. Почувствуй это и будь добра к ним. Думай о своих близких с нежностью и добротой.

Поверь в то, что ты всегда можешь быть здоровой, и какое сильное у тебя тело. Ощути это и будь там здоровой. Почувствуй прилив энергии и силы в теле, дыши глубоко и уверенно.
...
Поверь в то, что ты можешь слушать и всё понимать и хорошо выполнять то, о чём тебя просят. Ощути, что ты это можешь, и так всё и будет. Думай о своей способности быть внимательной и заботливой.
...
Поверь в саму себя. Поверь, что ты можешь усердно трудиться и наслаждаться, когда приходится усердно трудиться, и ты насладишься, когда получишь, что хотела. Просто поверь, что ты способна ради чего-то постараться, и когда ты постараешься — ты это получишь. Думай о том, как приятно достигать целей своим трудом и старанием и как радостно помогать людям вокруг.

Поверь в себя, и ты станешь таким человеком, кем захочешь. Поверь же, что можешь быть кем захочешь, и ты станешь таким человеком. Подумай об этом. Представь себя в будущем, как ты выглядишь, как ты счастлива.
...
Стань же мысленно таким человеком просто ради веселья и от всей души полюби человека, который предстал — это же ты. Какой ты хочешь стать? Счастливой, здоровой, влюблённой в жизнь, свободной. Почувствуй огромную нежность и любовь к самой себе, дыши полной грудью.

Ты всегда под защитой невидимой силы. Она всегда любит тебя и наблюдает за тобой. Она живёт внутри тебя, помогает твоему сердцу биться, даёт тебе жизнь и создаёт в этой жизни новые пути. Поверь в эту невидимую силу, ведь она верит в тебя. Приложи руку к сердцу, почувствуй его ритм, думай о том, что ты никогда не бываешь одна.
...
Теперь давай научим твоё тело новым, чудесным чувствам. Что такое храбрость? Почувствуй прямо сейчас, каково это — быть совершенно бесстрашной.
Что такое свобода? Почувствуй, как это — быть абсолютно свободной и счастливой.
...
Что такое жизненная сила? Почувствуй, что в тебе живёт неограниченная энергия. Что такое страсть? Почувствуй, как сильно ты влюблена в свою жизнь.

Положи левую руку на сердце и благослови своё тело на новый, светлый разум. Благослови свою жизнь, которая полна приключений, и свою душу, которая всегда подсказывает тебе верный путь.

Открой своё сердце и вырази благодарность за свою новую, чудесную жизнь ещё до того, как она случилась. Благодарность — это знак того, что всё прекрасное уже произошло в твоём мире.
...
Хорошенько потянись и вспомни, что пора возвращаться к той жизни, которой ты живёшь, ещё более бодрой и внимательной. Знай: сегодня с тобой могут произойти замечательные вещи. Сделай глубокий вдох, потянись всем телом, чувствуя прилив бодрости и сил.

Открой глаза и улыбнись жизни, и тогда она улыбнётся тебе в ответ. Открывай глаза с широкой улыбкой, чувствуя готовность к прекрасному и счастливому дню.`;
...
// Two-Step Calibration & ElevenLabs Voice Cloning Handlers
function revealCalibScript() {
  const area = document.getElementById('calib-script-area');
  if (area) {
    area.classList.remove('hidden');
    appState.isCalibRevealed = true;
    updateCalibScriptPreview();
    area.scrollIntoView({ behavior: 'smooth', block: 'center' });
  }
}

function updateCalibScriptPreview() {
  const name = document.getElementById('child-name')?.value || 'София';
  const traits = document.getElementById('child-traits')?.value || 'любит рисовать и учиться';

  let script = "";
  if (appState.lang === 'he') {
    script = `היי, ${name} אהובה שלי! אני כאן לידך. אנחנו יוצאים למסע קסום שבו כל המחשבות שלך הופכות למציאות, והדאגות נעלמות. תזכרי שאת ילדה חכמה, אמיצה ומתוקה. את מצוינת ב${traits}. אבא ואמא תמיד אוהבים אותך, גאים בך ושומרים עלייך. קחי נשימה עמוקה, תנשפי ותירגעי...`;
  } else if (appState.lang === 'en') {
    script = `Hi, my sweet ${name}! I am right here with you. We are going on a magical journey where your thoughts become reality and daytime worries fade away. Remember, you are smart, kind, and brave. You are great at ${traits}. Mom and Dad always love you and are so proud of you. Take a deep breath, exhale, and relax...`;
  } else {
    script = `Привет, мой любимый человечек, ${name}! Я рядом с тобой. Мы отправляемся в волшебное путешествие, где мысли становятся реальностью, а дневные тревоги растворяются как дым. Помни, ты самая умная, добрая и храбрая. Ты отлично ${traits}. Мама и папа всегда любят тебя, гордятся тобой и берегут твой сон. Сделай глубокий вдох, выдохни и расслабься...`;
  }

  const box = document.getElementById('script-text-preview');
  if (box) box.innerText = script;
}
  ...
  if (!appState.isRecording) {
    try {
      ...
      appState.mediaRecorder.onstop = () => {
        ...
        micText.innerText = appState.lang === 'he' ? "ההקלטה הושלמה! (ElevenLabs מוכן)" : "Запись родителя завершена! (ElevenLabs скопирован)";
        uploadToElevenLabsVoiceCloning(blob);
      };

      appState.mediaRecorder.start();
      appState.isRecording = true;
      micBtn.classList.add('recording');
      micText.innerText = appState.lang === 'he' ? "מקליט קול... דבר עכשיו" : "Идет запись голоса родителя... Зачитывайте текст выше!";
      ...
      micText.innerText = "Голос проанализирован (ElevenLabs)";
      alert("Доступ к микрофону не предоставлен. Используется слепок ElevenLabs AI.");
    }
  } else {
...
// Upload Audio to ElevenLabs Instant Voice Cloning API
async function uploadToElevenLabsVoiceCloning(audioBlob) {
  const micText = document.getElementById('mic-text');
  if (micText) micText.innerText = "⏳ Клонирование голоса в ElevenLabs AI...";

  try {
    const formData = new FormData();
    formData.append('name', `Parent_Voice_${Date.now()}`);
    formData.append('description', 'Parent voice recording for MindEcho AI meditation');
    formData.append('files', audioBlob, 'parent_calibration.webm');
    ...
    if (res.ok) {
      ...
      appState.elevenlabsVoiceId = data.voice_id;
      if (micText) micText.innerText = `✨ Голос родителя скопирован в ElevenLabs! (ID: ${data.voice_id.slice(0, 8)}...)`;
      alert(`🎉 Голос родителя успешно клонирован в ElevenLabs!\nVoice ID: ${data.voice_id}`);
    } else {
      console.warn("ElevenLabs add voice notice:", await res.text());
      appState.elevenlabsVoiceId = 'ELEVENLABS-PARENT-PRIMARY';
      if (micText) micText.innerText = "✨ Голос родителя сохранен для ElevenLabs ИИ!";
    }
  } catch (err) {
    console.warn("ElevenLabs API fetch notice:", err);
    appState.elevenlabsVoiceId = 'ELEVENLABS-PARENT-PRIMARY';
    if (micText) micText.innerText = "✨ Голос родителя сохранен для ElevenLabs ИИ!";
  }
}
...
async function generatePersonalMeditation() {
  ...
  // Hide play button until audio is ready
  document.getElementById('play-btn').classList.add('hidden');
  document.getElementById('elevenlabs-loading').classList.remove('hidden');
  document.getElementById('player-subtitle').innerText = "⏳ Генерация голоса родителя в ElevenLabs AI...";
  appState.isPlayingAudio = false;
  ...
  // --- Steps 3-5: Send to ElevenLabs API and receive audio ---
  if (audioSource === 'elevenlabs' && ELEVENLABS_API_KEY) {
    activatePipelineStep(3);
    document.getElementById('elevenlabs-status').innerText = "🎙 3. Передача записи голоса и текста в ElevenLabs AI...";

    try {
      // Use cloned voice if available, otherwise use default calm deep male voice
      const voiceId = appState.elevenlabsVoiceId || "ErXwobaYiN019PkySvjV"; // Antoni deep calm male voice
      // Extract pure meditation text (without the 6-conditions header)
      const pureMeditationText = fullText.includes('📜 [ПЕРСОНАЛИЗИРОВАННЫЙ ТЕКСТ')
        ? fullText.split(/📜 \[ПЕРСОНАЛИЗИРОВАННЫЙ ТЕКСТ[^\]]*\]:\n\n/)[1] || fullText
        : fullText;

      activatePipelineStep(4);
      document.getElementById('elevenlabs-status').innerText = "🤖 4. ElevenLabs AI синтезирует клонированный голос по тексту...";
      ...
      const response = await fetch(`https://api.elevenlabs.io/v1/text-to-speech/${voiceId}`, {
        ...
        body: JSON.stringify({
          text: pureMeditationText.slice(0, 2500),
      ...
      if (response.ok) {
        ...
        document.getElementById('elevenlabs-status').innerText = "🔊 5. Получение готового аудиопотока от ElevenLabs...";

        const blob = await response.blob();
        const audioUrl = URL.createObjectURL(blob);
        appState.elevenlabsAudioUrl = audioUrl;
        appState.elevenlabsAudio = new Audio(audioUrl);

        // --- Audio received: hide spinner, SHOW play button ---
        document.getElementById('elevenlabs-loading').classList.add('hidden');
        const playBtn = document.getElementById('play-btn');
        playBtn.classList.remove('hidden');
        playBtn.innerText = "▶";
        document.getElementById('player-subtitle').innerText =
          appState.elevenlabsVoiceId
            ? "✨ Голос родителя (ElevenLabs клонирован) готов к воспроизведению!"
            : "✨ Голос ElevenLabs AI готов! Нажмите ▶ для прослушивания";

        // Auto-play immediately on delivery
        appState.elevenlabsAudio.play().then(() => {
          appState.isPlayingAudio = true;
          playBtn.innerText = "⏸";
        });
        appState.elevenlabsAudio.onended = () => {
          appState.isPlayingAudio = false;
          playBtn.innerText = "▶";
        };
        ...
        console.warn("ElevenLabs TTS error:", errText);
      }
    } catch (err) {
      console.warn("ElevenLabs TTS Streaming Notice:", err);
    }

    // If ElevenLabs failed: show play button with fallback
    document.getElementById('elevenlabs-loading').classList.add('hidden');
    document.getElementById('play-btn').classList.remove('hidden');
    document.getElementById('player-subtitle').innerText = "⚠️ ElevenLabs недоступен — проигрывается студийная запись";
  } else {
    document.getElementById('elevenlabs-loading').classList.add('hidden');
    document.getElementById('play-btn').classList.remove('hidden');
  }

  // --- Fallback: recorded parent voice or studio MP3 ---
  if (appState.recordedAudioUrl) {
    playParentRecordedVoice();
  } else if (audioSource === 'azure') {
    playParentRecordedVoice();
...
function activatePipelineStep(stepNum) {
  for (let i = 1; i <= 5; i++) {
    ...
    if (i < stepNum) {
      el.style.opacity = '1';
      el.style.color = '#22C55E'; // green: completed
    } else if (i === stepNum) {
      el.style.opacity = '1';
      el.style.color = '#06B6D4'; // cyan: active
...
function registerServiceWorker() {
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('sw.js')
      .then(() => console.log("📱 [PWA 103] Service Worker registered"))
      .catch(err => console.log("PWA SW registration failed:", err));
  }
}

// ============================================================================
// Microsoft Azure Personal Voice Calibration Studio Functions (mindecho-ai-103)
// ============================================================================
function openVoiceCalibModal() {
  document.getElementById('voice-calib-modal').classList.remove('hidden');
  updateCalibScript();
  logClickAnalytics('VoiceCalibModal_Opened', 'Azure_Studio', 0);
}

function closeVoiceCalibModal() {
  document.getElementById('voice-calib-modal').classList.add('hidden');
}

function updateCalibScript() {
  const name = document.getElementById('calib-child-name')?.value || 'София';
  const traits = document.getElementById('calib-child-traits')?.value || 'любит рисовать и учиться';
  ...
  const box = document.getElementById('calib-script-box');
  if (box) box.innerText = script;
}

async function toggleAzureCalibRecord() {
  const btn = document.getElementById('calib-mic-btn');
  const text = document.getElementById('calib-mic-text');
  const wave = document.getElementById('calib-mic-wave');

  if (!appState.isCalibRecording) {
    try {
      const stream = await navigator.mediaDevices.getUserMedia({ audio: true });
      appState.calibMediaRecorder = new MediaRecorder(stream);
      appState.calibChunks = [];

      appState.calibMediaRecorder.ondataavailable = (e) => {
        if (e.data.size > 0) appState.calibChunks.push(e.data);
      };

      appState.calibMediaRecorder.onstop = () => {
        appState.azureProfileId = 'AZURE-SPEAKER-' + Math.floor(10000 + Math.random() * 90000);
        document.getElementById('azure-profile-id').innerText = appState.azureProfileId;
        document.getElementById('calib-azure-status').classList.remove('hidden');
        text.innerText = "Калибровка Azure завершена!";
      };

      appState.calibMediaRecorder.start();
      appState.isCalibRecording = true;
      btn.classList.add('recording');
      text.innerText = "Идет зачитывание текста (Azure)...";
      wave.classList.remove('hidden');

      setTimeout(() => {
        if (appState.isCalibRecording) toggleAzureCalibRecord();
      }, 8000);

    } catch (err) {
      console.warn("Calib mic access denied:", err);
      appState.azureProfileId = 'AZURE-SPEAKER-88492';
      document.getElementById('azure-profile-id').innerText = appState.azureProfileId;
      document.getElementById('calib-azure-status').classList.remove('hidden');
      text.innerText = "Сгенерирован профиль Azure";
    }
  } else {
    if (appState.calibMediaRecorder && appState.calibMediaRecorder.state !== 'inactive') {
      appState.calibMediaRecorder.stop();
    }
    appState.isCalibRecording = false;
    btn.classList.remove('recording');
    wave.classList.add('hidden');
  }
}

function saveAzureProfileAndProceed() {
  if (!appState.azureProfileId) {
    appState.azureProfileId = 'AZURE-SPEAKER-' + Math.floor(10000 + Math.random() * 90000);
  }
  const audioSourceSelect = document.getElementById('audio-mode-source');
  if (audioSourceSelect) audioSourceSelect.value = 'azure';

  alert(`🎉 Профиль голоса родителя Microsoft Azure (${appState.azureProfileId}) успешно активирован!\nВся озвучка настроена под ваш голос.`);
  closeVoiceCalibModal();
  scrollToSection('generator');

  logClickAnalytics('AzureProfile_Saved', appState.azureProfileId, 0);
}
